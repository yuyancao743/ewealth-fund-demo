...
const DOC_CATEGORIES = [
  ...
  { id: 'presentations', label: 'Presentations', labelZh: '路演材料 / 推介材料' },
  { id: 'research', label: 'research Documents', labelZh: '研究文件 / 投研报告' },
...
function perf(m1, m3, m6, ytd, y1, y3, rsi, mtd, annual) {
  return { m1, m3, m6, ytd, y1, y3, rsi, mtd, annual: annual || {} };
}
...
function defaultFundDocuments(f) {
  ...
  d.presentations['zh-CN'] = [mk('路演推介材料')];
...
const MMF_PRODUCTS = [
  {
    ...
    website_url: 'https://asset.pingan.com.hk/zh-hk/PACSIF-PAMMF',
    fund_managers: '李明、王芳',
    ...
    perf: perf(0.31, 0.96, 1.92, 1.94, 4.17, 15.71, 21.66, 0.31, { 2020: null, 2021: 0.30, 2022: 2.08, 2023: 5.60, 2024: 5.59, 2025: 4.54 }),
  ...
  },
  {
    ...
    fund_house_name: '泰康资产管理', fund_house_id: 'TAIKANG', fund_managers: '陈伟',
  ...
  },
  {
    ...
    fund_house_name: '广发基金', fund_house_id: 'GF', fund_managers: '赵强',
  ...
  },
  {
    ...
    fund_house_name: '大成基金', fund_house_id: 'DACHENG', fund_managers: '刘洋',
  ...
  },
  {
    ...
    fund_house_name: '博时基金', fund_house_id: 'BOSERA', fund_managers: '周杰',
  ...
  },
  {
    ...
    fund_house_name: '泰康资产管理', fund_house_id: 'TAIKANG', fund_managers: '孙丽',
